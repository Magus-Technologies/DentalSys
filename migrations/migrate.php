<?php
/**
 * Migrador casero para DentalSys.
 *
 *   USO (CLI):  php migrations/migrate.php
 *   USO (web):  http://localhost/dental/migrations/migrate.php?token=...
 *
...
// Token simple: en local sin restricción, en cualquier otro host se exige.
$esCli = (PHP_SAPI === 'cli');
