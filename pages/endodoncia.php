...
<div class="cols" style="margin-top:10px">
  ...
  <div class="col" style="flex:1"><div class="rxbox" style="height:100%">Rx. de<br>Odontometr&iacute;a</div></div>
</div>
...
<div class="cols">
  ...
  <div class="col" style="flex:1"><div class="rxbox" style="height:100%">Rx. de<br>Conometr&iacute;a</div></div>
</div>
...
<div class="cols" style="margin-top:8px">
  ...
  <div class="col" style="flex:1"><div class="rxbox" style="height:100%">Rx.<br>Obturaci&oacute;n</div></div>
</div>
...
<?php if(!empty($adjuntos)): $secLbl=['dolor'=>'Tipo de dolor','odontometria'=>'Odontometr&iacute;a','biomecanica'=>'Biomec&aacute;nica','obturacion'=>'Obturaci&oacute;n']; ?>
<div class="line" style="margin-top:6px">ARCHIVOS ADJUNTOS:</div>
<?php foreach($secLbl as $sec=>$lbl): if(empty($adjuntos[$sec])) continue; $a=$adjuntos[$sec]; $ext=strtolower(pathinfo($a['ruta'],PATHINFO_EXTENSION)); ?>
<div class="line" style="margin-left:12px">&bull; <?=$lbl?>: <a href="<?=BASE_URL?>/uploads/<?=e($a['ruta'])?>" target="_blank"><?=e($a['nombre']?:'archivo')?></a>
<?php if(in_array($ext,['jpg','jpeg','png','webp'])): ?><br><img src="<?=BASE_URL?>/uploads/<?=e($a['ruta'])?>" style="max-height:130px;max-width:220px;border:1px solid #ccc;margin:3px 0"><?php endif; ?>
</div>
