...
<div class="card"><div class="table-responsive"><table class="table mb-0">
 <thead><tr><th>Fecha/Hora</th><th>Usuario</th><th>Acción</th><th>Tabla</th><th>Registro</th><th>IP</th></tr></thead>
 <tbody>
 <?php foreach($lista as $a): ?>
 <tr>
  <td><small class="mon"><?=fDT($a['created_at'])?></small></td>
  <td><small><?=e($a['usr']??'Sistema')?></small></td>
  ...
  <td><small class="mon"><?=$a['registro_id']??'—'?></small></td>
  <td><small style="color:var(--t3)"><?=e($a['ip']??'—')?></small></td>
 </tr>
